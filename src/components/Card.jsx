...
function Card() {
    ...
    const items = [
        { 
            title: "Encoded Post", 
            description: "Hope uses steganography to let victims hide critical evidence—like abuse reports or safehouse/location details—inside an ordinary image file.",
        ...
        { 
            title: "Avatar Bot", 
            description: "Hope’s Avatar Bot is a 3D virtual assistant that lets survivors express their feelings. The avatar responds with empathetic voice replies and facial expressions, offering emotional support and guidance while maintaining complete anonymity.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
            title: "Law Bot", 
            description: "Law Bot is an AI-powered legal assistant that educates survivors about their rights and protections under the law.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
            ...
            description: "By simply texting your distress to ‘HOPE911’ , survivors trigger an emergency alert that discreetly shares their location and pre-set danger signals with trusted contacts or local authorities.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
